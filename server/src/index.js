...
const costControlDebitRouter = require('./routes/costControlDebit')
const creditReviewRouter = require('./routes/creditReview')
...
const fuelReceiptWebhookRouter = require('./routes/fuelReceiptWebhook')
const debitReceiptWebhookRouter = require('./routes/debitReceiptWebhook')
...
app.use('/api/cost-control-debit', costControlDebitRouter)
app.use('/api/credit-review', creditReviewRouter)
...
app.use('/api/fuel-receipt-webhook', fuelReceiptWebhookRouter)
app.use('/api/debit-receipt-webhook', debitReceiptWebhookRouter)
...
app.get('/api/health', (_, res) => res.json({ status: 'ok', version: '2026-09-24-keel-real-backend-9ff08b6' }))
