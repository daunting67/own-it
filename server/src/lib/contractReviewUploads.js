...
// Private Supabase Storage bucket for TEMPORARY subcontract-pack uploads —
// same pattern as tenderUploads.js. The browser uploads each schedule straight
// here via a signed upload URL (bypassing Vercel's ~4.5MB serverless
// request-body limit); the read step downloads it server-side. Removed once
// the review is filed.
const BUCKET = 'contract-review-uploads'
