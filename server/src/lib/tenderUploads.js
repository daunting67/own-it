...
// Private Supabase Storage bucket for TEMPORARY tender-pack uploads. The browser
// uploads each document straight here via a signed upload URL (bypassing Vercel's
// ~4.5MB serverless request-body limit); the read step downloads it server-side.
// Nothing here is meant to persist — uploads are removed once the debrief is filed.
