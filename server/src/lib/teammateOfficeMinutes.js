...
const FIELD_IDS = {
  ...
  meeting_date:      '659cabf8e0343f77b814d451',
...
// d = the structured office-minutes object; recordedByName = the portal user's name (for attribution)
async function submitOfficeMinutes(d, recordedByName) {
  ...
  const coordinator = findEmployee(employees, recordedByName) || findEmployee(employees, 'Tony Daunt') || employees[0]
  ...
  const body = {
    ...
    fields: {
      ...
      [FIELD_IDS.meeting_date]:      meetingDate,
